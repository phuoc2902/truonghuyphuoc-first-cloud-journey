...
1. Truy cập trang điều khiển **RDS → Databases**.
...
1. Truy cập dịch vụ **Amazon S3 → Buckets**.
...
1. Truy cập dịch vụ **Cognito → User Pools**.
...
1. Truy cập dịch vụ **Amazon CloudFront → Distributions**.
...
3. Nhấp chọn nút **Disable** và xác nhận để vô hiệu hóa cổng phân phối này trước khi tiến hành xóa:
   ...
   ![Vô hiệu hóa CloudFront Distribution](/images/5-Workshop/cloudfront_disable_distribution.png)

4. Khi trạng thái phân phối đã được vô hiệu hóa thành công, bạn sẽ nhận được thông báo sẵn sàng xóa:

   ![Trạng thái vô hiệu hóa hoàn tất](/images/5-Workshop/cloudfront_disabled_status.png)

5. Tích chọn Distribution, nhấn nút **Delete** và chọn **Delete** trên popup xác nhận để gỡ bỏ hoàn toàn:

   ![Xác nhận xóa Distribution](/images/5-Workshop/cloudfront_delete_distribution_confirm.png)
   ![Xóa Distribution thành công](/images/5-Workshop/cloudfront_delete_success.png)
